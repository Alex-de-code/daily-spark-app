...
const Nav = () => {
  ...
  <div className="flex-wrap justify-evenly items-center bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-200 via-red-200 to-yellow-100">
    <h2 className="text-2xl text-shadow cursor-pointer"><Link to="/">Daily Sparks !</Link></h2>
    <ul className="flex justify-between">
      <li className="flex-1 text-center hover:text-green-100 text-shadow-sm cursor-pointer drop-shadow-md scale-90"><Link to="src/SavedQuotes">Sparks</Link></li>
