    ...
    <>
      <div className="flex-wrap justify-evenly items-center bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-200 via-red-200 to-yellow-100 ">
        ...
        <ul className="flex justify-between">
          <li className="flex-1 text-center hover:text-green-100 text-shadow-sm cursor-pointer drop-shadow-md scale-90 mb-3 text-lg">
            <Link to="src/SavedQuotes">Sparks</Link>
          </li>
          <li className="flex-1 text-center hover:text-green-100 text-shadow-sm cursor-pointer drop-shadow-md scale-90 mb-3 mt-2 text-lg">
